...
export class NetworkStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: StackProps = {}) {
    ...
    // Create the Hobby VPC, which has a NAT instance, a public subnet, a private subnet, a test instance, and a Lambda that keeps that NAT instances
    // off after hours to save money.
    this.vpc = new HobbyVPC(this, 'Network', {
      createTestInstance: false,
      turnOffAtNight: true,
    }).vpc;
...
new ApplicationStack(app, 'CommunityOrdering-Application', {
  env: devEnv,
